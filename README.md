...
- 使用限制：
  ...
  - 当前免费计划示例：`openai/gpt-oss-120b` / `openai/gpt-oss-20b` 和 `qwen/qwen3.6-27b` 为 `30 RPM` / `1K RPD` / `8K TPM` / `200K TPD`；`qwen/qwen3.8-27b` 为 `30 RPM` / `1K RPD` / `8K TPM` / `2M TPD`
...
- 免费内容：
  ...
  - 官方新人免费额度说明写明，首次开通百炼时会自动发放符合条件模型的新人免费额度；当前主规则为 `90 天`，`2025-09-08 11:00` 前已开通用户的有效期可能不足 `90 天`
...
- 免费内容：
  ...
  - `Token Plan` 文档当前面向企业 / 团队场景，给出独立套餐 API Key，并列出 `Spark X2` / `Spark-X2-Flash`、`GLM-5.2` / `GLM-5.1` / `GLM-5`、`DeepSeek-V4-Pro`、`DeepSeek-V4-Flash`、`DeepSeek-V3.2`、`Kimi-K2.6`、`Kimi-K2.5`、`MiniMax-M2.5`、`Qwen3.5` / `Qwen3.6`、`Qwen3-Coder-Next-FP8`、`GLM-4.7-Flash` 等可切换模型示例；计量按积分消耗，并有工作日非高峰、周末等 `0.8` 时段系数
...
- 使用限制：
  ...
  - `Coding Plan` 官方当前默认模型标识为 `astron-code-latest`，并列出 `Spark X2` / `Spark X2 Agent` / `Spark-X2-Flash`、`GLM-5.2` / `GLM-5.1` / `GLM-5`、`DeepSeek-V4-Pro`、`DeepSeek-V4-Flash`、`DeepSeek-V3.2`、`Kimi-K2.7-Code`、`Kimi-K2.6`、`MiniMax-M2.5`、`Qwen3.5` / `Qwen3.6`、`Qwen3-Coder-Next-FP8`、`GLM-4.7-Flash` 等当前模型池示例；`2026-07-23` 版本的模型抵扣系数表中 `Kimi-K2.7-Code` 的 `modelId` 为 `xopkimi27code`，抵扣系数为 `5`，`MiniMax-M2.5` 的 `modelId` 为 `xminimaxm25`
...
- 官网：[混元大模型计费概述](https://cloud.tencent.com/document/product/1729/97731) / [TokenHub](https://console.cloud.tencent.com/tokenhub)
- 类型：模型 API
- 注册方式：腾讯云账号开通混元或 TokenHub，按要求完成实名认证
...
- [Cohere](providers/cohere/README.md)
- [Hugging Face](providers/huggingface/README.md)
- [Groq](providers/groq/README.md)
- [Mistral](providers/mistral/README.md)
- [Cerebras](providers/cerebras/README.md)
- [NVIDIA NIM](providers/nvidia-nim/README.md)
- [GitHub Models](providers/github-models/README.md)
- [Vercel AI Gateway](providers/vercel-ai-gateway/README.md)
- [Cloudflare Workers AI](providers/cloudflare-workers-ai/README.md)
- [DashScope / 百炼](providers/dashscope/README.md)
- [SiliconFlow](providers/siliconflow/README.md)
- [Agnes AI](providers/agnes-ai/README.md)
- [百度千帆](providers/baidu-qianfan/README.md)
- [讯飞星辰 MaaS](providers/xfyun-maas/README.md)
- [腾讯混元](providers/tencent-hunyuan/README.md)
- [火山方舟](providers/volcengine-ark/README.md)
