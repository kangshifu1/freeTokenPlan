...
7. 打开 [Pricing](https://vercel.com/docs/ai-gateway/pricing)，确认免费档是否仍是 `$5/month` credits、是否已经购买过 credits，以及目标模型是否属于 eligible models
8. 若通过 CC Switch 使用，先确认当前 Vercel AI Gateway 是否暴露可被该版本识别的 OpenAI-compatible base URL；如需 BYOK provider keys，需要确认账号是否在支持该功能的付费计划上
...
- 目标模型是否属于免费 credits 覆盖的 eligible models
