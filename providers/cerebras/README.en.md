...
- Models: check the official [Models](https://inference-docs.cerebras.ai/models) page for current model IDs; the public shared endpoints currently list `gpt-oss-120b` and `gemma-4-31b`
