...
9. 如果使用 `Coding Plan`，默认模型先记录为 `astron-code-latest`，也可以按官方列表切换到底层 `modelId`，例如 `xopglm52`、`xopglm51`、`xopglm5`、`xopdeepseekv4pro`、`xopdeepseekv4flash`、`xopdeepseekv32`、`xopkimi27code`、`xopkimik26`、`xopkimik25`、`xopqwen35397b`、`xopqwen36v35b`、`xop3qwencodernext`、`xopglmv47flash`
