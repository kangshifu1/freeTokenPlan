...
9. 如果使用 `Coding Plan`，默认模型先记录为 `astron-code-latest`，也可以按官方列表切换到底层 `modelId`，例如 `xsparkx2agent`、`xsparkx2`、`xsparkx2flash`、`auto`、`xopglm52`、`xopglm51`、`xopglm5`、`xopdeepseekv4pro`、`xopdeepseekv4flash`、`xopdeepseekv32`、`xopkimi27code`、`xopkimik26`、`xopkimik25`、`xminimaxm25`、`xopqwen35397b`、`xopqwen36v35b`、`xopqwen35v35b`、`xop3qwencodernext`、`xopglmv47flash`
...
12. 若在夜间、周末或节假日错峰使用，按当前文档确认 `0.8` 系数是否仍适用于流控 / 积分消耗，并核对 `Kimi-K2.7-Code` 等高扣减模型的最新抵扣系数
