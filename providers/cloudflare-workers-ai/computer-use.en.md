...
9. On the Pricing page, confirm whether the target model is available on Workers Free; `@cf/moonshotai/kimi-k2.6`, `@cf/moonshotai/kimi-k2.7-code`, and `@cf/zai-org/glm-5.2` currently require Workers Paid
