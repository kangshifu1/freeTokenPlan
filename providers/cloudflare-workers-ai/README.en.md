...
- Free-plan model scope: the pricing page currently says `@cf/moonshotai/kimi-k2.6`, `@cf/moonshotai/kimi-k2.7-code`, and `@cf/zai-org/glm-5.2` are not available on Workers Free and require Workers Paid
