...
- Free plan 模型范围：定价页当前明确 `@cf/moonshotai/kimi-k2.6`、`@cf/moonshotai/kimi-k2.7-code`、`@cf/zai-org/glm-5.2`、`@cf/deepseek-ai/deepseek-v4-flash-0731`、`@cf/deepseek-ai/deepseek-v4-pro-0813` 不支持 Workers Free plan，需要 Workers Paid plan 或预付 AI Gateway credits
