...
- Current examples: `groq/compound` / `groq/compound-mini` have `30 RPM` / `250 RPD` / `70K TPM`; `meta-llama/llama-prompt-guard-2-22m` / `meta-llama/llama-prompt-guard-2-86m` have `30 RPM` / `14.4K RPD` / `15K TPM` / `500K TPD`; `openai/gpt-oss-120b` / `openai/gpt-oss-20b` and `qwen/qwen3.6-27b` have `30 RPM` / `1K RPD` / `8K TPM` / `200K TPD`
