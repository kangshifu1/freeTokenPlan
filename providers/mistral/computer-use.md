...
7. 查看 Studio / Console、[Mistral Pricing](https://mistral.ai/pricing) 和 [Activate Studio and generate an API key](https://docs.mistral.ai/getting-started/quickstarts/studio/activate-and-generate-api-key) 页面，确认当前 API `Free mode`、无需信用卡试用、rate limit、`Mistral Free` / `Vibe for code` 计划说明，以及 Free 计划是否仍列出 `$10/月` API credits
...
- 是否已创建 key
- 是否记录当前免费模式条件、Free 计划 API credits、workspace 计划和 key / 计费边界
