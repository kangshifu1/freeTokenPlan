...
9. Record whether the account received a TokenHub new-user trial package or the legacy Hunyuan package. The current TokenHub language and multimodal-understanding trial packages are `1M Tokens / 90 days`; image generation is `50 generations / 365 days`, video generation is `50 points / 365 days`, and 3D generation is `100 points / 365 days`; the current Hunyuan text-generation / multimodal shared package is `1M tokens / 1 year`
