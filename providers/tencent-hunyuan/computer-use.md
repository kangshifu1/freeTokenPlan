...
9. 记录当前领取的是 TokenHub 新用户体验包还是混元存量资源包；TokenHub 新用户体验包页面于 `2026-07-21` 更新，语言模型和多模态理解体验包当前为 `100万 Tokens / 1 年`，视觉模型当前公开的免费包为视频生成 `50 积分 / 1 年` 和 3D 生成 `100 积分 / 1 年`，混元生文 / 多模态共享资源包当前为 `100万 tokens / 1 年`
...
- TokenHub 各类体验包和混元存量资源包的入口、有效期、模型范围、计量口径没有混记，且 TokenHub 活动截止时间仍与官方页面一致
