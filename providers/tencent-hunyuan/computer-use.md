...
8. 打开 [混元计费概述](https://cloud.tencent.com/document/product/1729/97731)，确认当前入口是否已迁移到 `TokenHub`
9. 记录免费资源包、共享模型范围、有效期，以及 `Hunyuan-lite` 是否被排除在共享资源包外
...
- 免费资源包是否已发放
- 有效期是否与控制台一致
- 当前模型是否在共享资源包范围内，或是否需要在 `TokenHub` 另行开通
