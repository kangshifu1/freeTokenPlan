...
9. 记录当前领取的是 TokenHub 新用户体验包还是混元存量资源包；TokenHub 语言模型体验包当前为 `100万 tokens / 90 天`，混元生文 / 多模态共享资源包当前为 `100万 tokens / 1 年`
10. 记录免费资源包、共享模型范围、有效期、入口来源，以及 `Hunyuan-lite` 是否被排除在共享资源包外
...
- TokenHub 体验包和混元存量资源包的入口、有效期、模型范围没有混记
