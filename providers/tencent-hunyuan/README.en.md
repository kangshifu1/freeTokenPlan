...
- Website: [Hunyuan billing overview](https://cloud.tencent.com/document/product/1729/97731) / [TokenHub](https://console.cloud.tencent.com/tokenhub)
...
- Compatibility: Tencent Hunyuan documents OpenAI-compatible access; current TokenHub / Hunyuan base URLs, authentication details, and model names should be verified in official docs
