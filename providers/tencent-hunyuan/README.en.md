...
- TokenHub trial package: the official TokenHub new-user trial page currently lists language, multimodal-understanding, image-generation, video-generation, and 3D-generation packages. Language and multimodal-understanding packages provide `1M tokens` after real-name verification, valid for `90 days`; visual-generation packages are metered by uses or points
