...
- 使用边界：`Token Plan 个人版`仅限兼容 AI 编程和智能体工具中的交互式使用，不应混同为普通新用户免费额度，也不应用作自动化脚本或应用后端
- 推荐用途：中国大陆用户试用国产模型、DeepSeek/Kimi/Qwen 等聚合模型、OpenAI 兼容 agent 接入、`Codex` / `Claude Code` / `CC-Switch` 的 Token Plan 工具接入
- 参考：[Token Plan 个人版](https://cloud.baidu.com/doc/qianfan/s/Dmrabu8b6)、[快速开始](https://cloud.baidu.com/doc/qianfan/s/kmracfgi2)、[CC-Switch 接入](https://cloud.baidu.com/doc/qianfan/s/Tmrad8foj)、[停售公告](https://cloud.baidu.com/doc/qianfan/s/Fmrexuejc)
