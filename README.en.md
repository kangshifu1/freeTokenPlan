...
|---|---|---|---|---|
| [Gemini](providers/gemini/README.en.md) | Long-term model-dependent Free tier; current official examples include `gemini-3.6-flash` | `CC Switch` / OpenAI-compatible gateway | Yes | [AI Studio](https://aistudio.google.com/) |
...
| [Cloudflare Workers AI](providers/cloudflare-workers-ai/README.en.md) | Daily `10,000` Neurons free allocation, model-cost dependent; some new models require Workers Paid or prepaid AI Gateway credits | Workers / edge demos | Yes | [Cloudflare Dashboard](https://dash.cloudflare.com/) |
