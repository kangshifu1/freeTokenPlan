...
|---|---|---|---|---|
| [Gemini](providers/gemini/README.en.md) | Long-term model-dependent Free tier; current official examples include `gemini-3.7-flash` / `gemini-3.6-flash` | `CC Switch` / OpenAI-compatible gateway | Yes | [AI Studio](https://aistudio.google.com/) |
