...
| [Baidu Qianfan](providers/baidu-qianfan/README.en.md) | New-user model token grants, commonly `1M tokens / 3 months`; new coding-tool purchases now route through `Token Plan personal` | Domestic models / OpenAI-compatible agents / Token Plan tools | Yes | [Qianfan Console](https://console.bce.baidu.com/qianfan/) |
