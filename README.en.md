...
| [Tencent Hunyuan / TokenHub](providers/tencent-hunyuan/README.en.md) | TokenHub new-user trial package is commonly `1M tokens / 90 days`; legacy Hunyuan also has a shared `1M tokens / 1 year` package | Hunyuan text generation / TokenHub models | Yes | [TokenHub](https://console.cloud.tencent.com/tokenhub) |
